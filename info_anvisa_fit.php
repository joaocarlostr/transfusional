    ...
    <div class="container-index">
        <div class="fundo-imagem">
            <div id="corpo" class="borda">
                <p class="mensagem-borda"><strong>ANVISA - FIT</strong></p>
                <div id="texto" class="text-index">
                    <h5><strong>Arquivos ANVISA - FIT</strong></h5>
                    <p>A ANVISA(Agência Nacional de Vigilância Sanitária) utiliza os dados da FIT(Ficha de Investigação Transfusional) para monitorar a segurança dos procedimentos transfusionais, identificar tendências,
                        adotar medidas corretivas e promover melhorias na qualidade dos serviços de hemoterapia. Essa vigilância contribui
                        para a prevenção de eventos adversos, aprimoramento dos protocolos transfusionais e garantia da segurança dos pacientes.
                    </p>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4 mx-auto">
                            <div class="pdf-list">
                                ...
                                <ul id="fileList">
                                    <?php
                                    // Primeira coluna - anos de 2007 a 2018
                                    for ($ano = 2007; $ano <= 2018; $ano++) {
                                        // Define o URL de destino para cada ano
                                        $url = "info-anvisa/arq_$ano.php"; // URL para o arquivo específico de cada ano
                                        echo "<li><a href=\"$url\" class=\"pdf-link\"><i class=\"fas fa-folder\"></i> $ano</a></li>";
                                    }
                                    ?>
                                </ul>
                        ...
                        <div class="col-lg-4 mx-auto">
                            <div class="pdf-list">
                                <ul id="fileList">
                                    <?php
                                    // Segunda coluna - anos de 2018 a 2024
                                    for ($ano = 2019; $ano <= 2024; $ano++) {
                                        echo "<li><a href=\"#\" class=\"pdf-link\"><i class=\"fas fa-folder\"></i> $ano</a></li>";
                                    }
                                    ?>
                                </ul>
                            </div>
