<?php
    ...
    // Assume que FPDF já foi incluído pelo gerar_relatorio.php
    ...
    // Tenta mostrar uma variável que vem do gerar_relatorio.php para confirmar
    $msg = isset($data_inicio) ? "Data Inicio: $data_inicio" : "Sem data";
    $pdf->Cell(0, 10, $msg, 0, 1);
    
    // Usa a função helper definida no gerar_relatorio.php se existir, senão usa Output direto
