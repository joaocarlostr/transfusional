    ...
    <div class="container-index">
        <div class="fundo-imagem">
            <div id="corpo" class="borda">
                <p class="mensagem-borda"><strong>Informações - Comitê Transfusional</strong></p>
                <div id="texto" class="text-index">
                    <h5><strong>Atas do Serviço Transfusional</strong></h5>
                    <p>Aqui você encontrará as Atas do Serviço Transfusional, que são documentos que registram detalhes das atividades, procedimentos e decisões relacionadas ao serviço transfusional do HUM.
                        São importantes não apenas para manter um registro detalhado das atividades e decisões, mas também para garantir a conformidade com regulamentações, promover a melhoria contínua da qualidade e fornecer uma base para a revisão e aprimoramento das práticas transfusionais.
                    </p>
                </div>
