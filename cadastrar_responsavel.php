    ...
    <div class="container container-cp">
        <div class="card-modern">
            <div class="card-header-modern">
                <i class="fas fa-user-md mr-2"></i> Cadastro de Responsável
            </div>
            <div class="card-body-modern">
                <form action="insere.php" method="POST" name="form" id="form_responsavel">
                    ...
                    <div class="row">
                        <div class="col-md-9 form-group">
                            <label for="responsavel" class="required">Nome do Responsável</label>
                            <input type="text" name="responsavel" id="responsavel" maxlength="200" autocomplete="off" required placeholder="Digite o nome completo">
                        </div>
                    ...
                    <div class="botoes-responsavel">
                        ...
                        <button type="button" class="btn-modern btn-primary-modern" data-toggle="modal" data-target="#responsavel_modal">
                ...
                <hr>
                <h5 class="text-center" style="color: #4a5568;">Responsáveis Cadastrados</h5>
                                ...
                                if (!$result_responsavel) {
                                    ...
                                    if(pg_num_rows($result_responsavel) > 0) {
                                        while ($row_responsavel = pg_fetch_assoc($result_responsavel)) {
                                            ...
                                            echo "<tr>
                                                    <td> {$row_responsavel['nome']} </td> 
                                                    <td class='text-center'><input type='checkbox' name='status_responsavel' $status onclick='return false;' style='width: 16px; height: 16px;'></td>
                                                </tr>";
                                        }
                                    }else{
                ...
                <!-- Modal de edição -->
                <div class="modal fade" id="responsavel_modal" tabindex="-1" role="dialog" aria-hidden="true">
                            ...
                            <div class="modal-body">
                                <form action="atualiza.php" method="POST" name="form_editar" id="form_responsavel_editar">
                                    <div class="form-group">
                                        <label for="responsaveis" class="required">Selecione o responsável</label>
                                    ...
                                    <div class="form-group">
                                        <label for="responsavel_editar" class="required">Novo nome do responsável</label>
                                    ...
                                    <div class="mt-4 text-center">
                                        <button type="submit" class="btn-modern btn-success-modern" name="atualizar_responsavel">Salvar Alterações</button>
                                    </div>
                                </form>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="helpModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p><strong>Como adicionar um responsável?</strong></p>
                    <ul>
                        <li>Insira o nome do responsável.</li>
                        <li>Selecione "Ativo" se o responsável estiver em uso.</li>
                        <li>Clique em "Adicionar".</li>
                    </ul>
                    <p><strong>Como editar um responsável?</strong></p>
                    <ul>
                        <li>Clique em "Editar".</li>
                        <li>Selecione o responsável na lista.</li>
    ...
    <script>
        function editar() {
            ...
            if(selectedResponsavel.value === "") {
                document.getElementById('responsavel_editar').value = "";
                document.getElementById('status_editar').checked = false;
                return;
            }

            document.getElementById('responsavel_editar').value = selectedResponsavel.text.trim();
